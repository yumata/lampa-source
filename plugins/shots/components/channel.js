...
function component(object){
    ...
    let comp     = Lampa.Maker.make('Category', object, (module)=>module.toggle(Lampa.Maker.module('Category').MASK.base, 'Pagination'))
    let playlist = []

    comp.use({
        onCreate: function(){
            Api.shotsChannel(object.id, object.page, (result)=>{
