(function () {
    ...
    var html$f = "<div class=\"time-line\" data-hash=\"{hash}\">\n    <div style=\"width: {percent}%\"></div>\n</div>";
    ...
    var templates = {
      ...
      activity: html$Y,
      settings: html$W,
      settings_main: html$V,
      settings_interface: html$U,
      settings_parser: html$T,
      settings_server: html$S,
      ...
      modal: html$y,
      company: html$x,
      modal_loading: html$w,
      modal_pending: html$v,
      actor_start: html$u,
      empty: html$t,
      notice: html$s,
      torrent: html$r,
      ...
      about: html$o,
      error: html$n,
      torrent_noconnect: html$m,
      styles: html$j,
      torrent_nocheck: html$l,
      torrent_nohash: html$k,
      filter: html$C,
      search_box: html$i,
      console: html$h,
      icon_star: html$g,
    ...
    function update$1(params) {
      ...
      var line = $('.time-line[data-hash="' + params.hash + '"]').removeClass('hide');
      $('> div', line).css({
    ...
    function show(files) {
      ...
      plays.forEach(function (element) {
        var hash = Timeline.hash(element, active.movie),
      ...
      this.filtred = function () {
        ...
        filtred = results.Results.filter(function (element) {
          if (filter_any) {
            ...
            if (sub) {
              if (sub == 1) check(' sub');else check(' sub', true);
            }
