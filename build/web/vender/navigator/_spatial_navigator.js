   ...
   */
  Class.SpatialNavigator = function() {
    this._focus = null;
    this._previous = null;
  ...
  Class.SpatialNavigator.prototype = {
    /**
    ...
    focus: function snFocus(elem) {
      ...
      if (!this.silent) {
        this.dispatchEvent({type: 'focus', elem: this._focus});
      }
      return true;
    },
    ...
    unfocus: function snUnfocus() {
      if (this._focus) {
        ...
        this._focus = null;
        if (!this.silent) {
          this.dispatchEvent({type: 'unfocus', elem: elem});
        }
      }
      return true;
    },
