...
function init(){
    ...
    else if ((agent.indexOf("mac os x") > -1 && !Utils.isTouchDevice())){
        Storage.set('platform', 'macos')
    }
 ...
 */
function any(){
    return is('tizen') || is('webos') || is('android') || is('netcast') || is('orsay') || is('macos') || is('apple') || is('apple_tv') || desktop() ? true : false
}
