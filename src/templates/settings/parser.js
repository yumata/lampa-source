let html = `<div>
    ...
    <div data-parent="parser">
        ...
        <div class="settings-param-title" data-parent="type-prowlarr"><span>Prowlarr</span></div>

        <div class="settings-param selector" data-type="input" data-name="prowlarr_url" placeholder="#{settings_parser_jackett_placeholder}" data-parent="type-prowlarr">
            <div class="settings-param__name">#{settings_parser_jackett_link}</div>
            <div class="settings-param__value"></div>
            <div class="settings-param__descr">#{settings_parser_prowlarr_link_descr}</div>
        </div>

        <div class="settings-param selector" data-type="input" data-name="prowlarr_key" data-string="true" placeholder="#{settings_parser_jackett_key_placeholder}" data-parent="type-prowlarr">
            <div class="settings-param__name">#{settings_parser_jackett_key}</div>
            <div class="settings-param__value"></div>
