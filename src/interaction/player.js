...
function iptv(data){
    locked(data, ()=>{
        ...
        start(data, data.torrent_hash ? 'iptv' : '', lauch)
        ...
        //     else if(Storage.field('player_iptv') == 'svplayer')window.location.assign('svplayer://x-callback-url/stream?url=' + encodeURIComponent(data.url))
