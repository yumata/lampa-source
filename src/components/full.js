    ...
    comp.use({
        onCreate: function(){
            ...
            Api.full(object, (data)=>{
                ...
                if(lgbt_block && key_tags && Arrays.isArray(key_tags) && key_tags.length && window.lampa_settings.lgbt) {
                ...
                let adult_block = key_tags && Arrays.isArray(key_tags) ? key_tags.find(key=>Keys.adult.find(word=>key.name.toLowerCase().indexOf(word) >= 0)) : null
