export default {
    ...
    torrent_parser_magnet_error: 'Неудалось получить magnet ссылку',
    ...
    settings_param_lang_en: 'Английский',
    ...
    helper_torrents_view: 'Для сброса таймкода и вызова меню удерживайте клавишу (ОК)',
    ...
    fav_clear_time_title: 'Очистить таймкоды',
    fav_clear_time_descr: 'Очистить все таймкоды',
    fav_label_cleared: 'Отметки очищены',
    fav_time_cleared: 'Таймкоды очищены',
    ...
    player_size_115_title: 'Увеличить 115%',
    player_size_115_descr: 'Увеличить видео на 115%',
    player_size_130_title: 'Увеличить 130%',
    player_size_130_descr: 'Увеличить видео на 130%',
