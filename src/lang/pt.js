export default {
    ...
    torrent_error_complete: 'Para completar',
    ...
    torrent_parser_no_response: 'O analisador não está respondendo à solicitação',
    ...
    copy_success: 'Endereço copiado para a área de transferência',
    copy_error: 'Erro ao copiar o endereço',

	account_sync_to_profile: 'Todos os favoritos serão movidos para o perfil',
    account_sync_success: 'Todos os favoritos foram transferidos com sucesso',
    ...
    account_export_success: 'Exportação concluída com sucesso',
    account_export_fail: 'Erro de exportação',
    account_import_success: 'Importação concluída com sucesso',
