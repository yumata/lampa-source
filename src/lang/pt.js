export default {
	...
	ivi_premieres: 'Estreias de filmes',
    ivi_best: 'Melhores filmes',
    ivi_popular: 'Popular agora',
    ivi_choice: 'Escolha IVI',
    ivi_new: 'Novo',
    ivi_foreign: 'Estrangeiro',
    ivi_ru: 'Russos',
    ivi_recomend: 'Recomendamos que você veja',
    ivi_for_famaly: 'Desenhos para toda a família',
    ivi_triller: 'Thrillers de terror',
    ivi_advance: 'Comédias de aventura',
    ivi_detective: 'Adaptações cinematográficas de detetives',
    ivi_crime_comedy: 'Comédias de crime',
    ivi_romantic: 'Dramas românticos',
    ivi_crime_dramas: 'Dramas criminais',
    ivi_fantastic_dramas: 'Dramas de fantasia',
    ivi_military_dramas: 'Dramas militares',
    ivi_mistic: 'Filmes de mistério',
    ivi_foreign_series: 'Série estrangeira',
    ivi_historical_series: 'Série histórica',

	okko_top_new: 'Top Novos',
    okko_comedy_horror: 'Filmes de terror de comédia',
    okko_collection_maniacs: 'Filmes sobre maníacos',
    okko_witches: 'Filmes sobre bruxas',
    okko_zombies: 'Filmes sobre zumbis',
    okko_ru: 'Russos',
    okko_horror_serial: 'Muito assustador',
    okko_serial_killers: 'Sobre maníacos',
    okko_humor_serial: 'Com humor negro',
    okko_legkiye_serialy: 'Pulmões',
    okko_comedy_serial: 'Comédia',
    okko_ru_tv: 'Russos',
