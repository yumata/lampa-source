export default {
    ...
    torrent_error_complete: 'Завяршыць',
    ...
    torrent_parser_no_response: 'Парсер не адказвае на запыт',
    ...
    account_export_success: 'Экспарт паспяхова завершаны',
    account_export_fail: 'Памылка пры экспарце',
    account_import_success: 'Імпарт паспяхова завершаны',
