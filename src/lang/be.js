export default {
    ...
    settings_senplayer_launch_mode: 'Запуск у SenPlayer',
    settings_senplayer_launch_mode_descr: 'Што рабіць пры адкрыцці відэа ў SenPlayer. Для торэнтаў заўжды адразу прайграванне',
    settings_senplayer_launch_ask: 'Пытаць пры запуску',
    settings_senplayer_launch_play: 'Гуляць',
    settings_senplayer_launch_save_and_play: 'Захаваць і гуляць',
    ...
    title_action_senplayer: 'Дзеянне SenPlayer',
