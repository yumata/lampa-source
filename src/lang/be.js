export default {
    ...
    ivi_ru: 'Рускія',
    ivi_popular: 'Папулярнае зараз',
    ivi_recomend: 'Рэкамендуем вам паглядзець',
    ivi_for_famaly: 'Мульцікі для ўсёй сям\'і',
    ivi_triller: 'Трылеры-жахі',
    ivi_advance: 'Прыгодніцкія камедыі',
    ivi_detective: 'Экранізацыі дэтэктываў',
    ivi_crime_comedy: 'Крымінальныя камедыі',
    ivi_romantic: 'Рамантычныя драмы',
    ivi_crime_dramas: 'Крымінальныя драмы',
    ivi_fantastic_dramas: 'Фантастычныя драмы',
    ivi_military_dramas: 'Ваенныя драмы',
    ivi_mistic: 'Містычныя фільмы',
    ivi_foreign_series: 'Замежныя серыялы',
    ivi_historical_series: 'Гістарычныя серыялы',

    okko_top_new: 'Топ-навінкі',
    okko_comedy_horror: 'Камедыйныя фільмы жахаў',
    okko_collection_maniacs: 'Фільмы пра маньякаў',
    okko_witches: 'Фільмы пра ведзьмаў',
    okko_zombies: 'Фільмы пра зомбі',
    okko_ru: 'Рускія',
    okko_horror_serial: 'Вельмі страшныя',
    okko_serial_killers: 'Пра маньякаў',
    okko_humor_serial: 'З чорным гумарам',
    okko_legkiye_serialy: 'Лёгкія',
    okko_comedy_serial: 'Камедыйныя',
    okko_ru_tv: 'Рускія',
    ...
    plugins_catalog_work: 'Працоўныя плагіны',
    ...
    plugins_install_ready: 'Гэтая плягін ужо ўсталяваны.',
    ...
    settings_param_background_image: 'Малюначак',
    ...
    fav_sync_text: 'Хочаш, каб твае любімыя закладкі былі на ўсіх тваіх прыладах? <br><br>Зарэгіструйся на сайце www.cub.watch, ствары профіль і аўтарызуйся ў лямпе.',
    fav_sync_site: 'Сайт',
    ...
    notice_none_account: 'У вас яшчэ няма ніякіх апавяшчэнняў, дадайце серыялы ў закладкі і чакайце апавяшчэння аб новых серый.',
}
