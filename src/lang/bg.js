export default {
    ...
    torrent_error_complete: 'За да завършите',
    ...
    torrent_parser_no_response: 'Анализаторът не отговаря на заявката',
    ...
    account_export_success: 'Експортирането завърши успешно',
    account_export_fail: 'Грешка при експортиране',
    account_import_success: 'Импортирането завърши успешно',
