...
suite('Title tests', () => {
    ...
    testTitle('One Punch Man S2/[anti-raws]One Punch Man ep.12[BDRemux].mkv',2,12)
    testTitle('One Punch Man Season 2/[anti-raws]One Punch Man ep.13[BDRemux].mkv',2,13)
    testTitle('e02 super mario.mkv',1,2)
    testTitle('e01 super mario.mkv',1,1)
    testTitle('E11 super mario.mkv',1,11)
    testTitle('2004 E11 super mario.mkv',1,11)
    testTitle('2004 3-12 super mario.mkv',3,12)
    testTitle('One_Punch_Man_S02_E03_MPEG4_2015_SATRip.mkv',2,3)
    testTitle('One_Punch_Man_03x07_MPEG4_2015_SATRip.mkv',3,7)
    testTitle('One_Punch_Man_05-06_MPEG4_2015_SATRip.mkv',5,6)
})