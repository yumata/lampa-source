export default {
    ...
    settings_senplayer_launch_mode: 'SenPlayer 启动方式',
    settings_senplayer_launch_mode_descr: '在 SenPlayer 中打开视频时的操作。种子始终立即播放',
    settings_senplayer_launch_ask: '启动时询问',
    settings_senplayer_launch_play: '播放',
    settings_senplayer_launch_save_and_play: '保存并播放',
    ...
    title_action_senplayer: 'SenPlayer 操作',
    title_producer: '制片人',
    title_collection: '合集',
