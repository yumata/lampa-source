export default {
    ...
    torrent_error_complete: 'Завершить',
    ...
    torrent_parser_no_response: 'Парсер не отвечает на запрос',
    ...
    account_sync_success: 'Все закладки успешно перенесены',
    ...
    account_export_success: 'Экспорт успешно завершён',
    ...
    account_import_success: 'Импорт успешно завершён',
