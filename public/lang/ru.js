export default {
    ...
    settings_senplayer_launch_mode: 'Запуск в SenPlayer',
    settings_senplayer_launch_mode_descr: 'Что делать при открытии видео в SenPlayer. Для торрентов всегда сразу воспроизведение',
    settings_senplayer_launch_ask: 'Спрашивать при запуске',
    settings_senplayer_launch_play: 'Играть',
    settings_senplayer_launch_save_and_play: 'Сохранить и играть',
