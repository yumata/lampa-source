export default {
    ...
    settings_player_torrent_m3u_download: 'Спампаваць .m3u (знешні плэер)',
    torrent_m3u_downloaded: 'Файл .m3u спампаваны. Адкрыць у плэеры і адзначыць серыю як прагледжаную?',
