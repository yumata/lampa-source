export default {
    ...
    torrent_error_complete: 'Завершити',
    ...
    account_export_success: 'Експорт успішно завершено',
    account_export_fail: 'Помилка під час експорту',
    account_import_success: 'Імпорт успішно завершено',
    ...
    torrent_parser_no_response: 'Парсер не відповідає на запит',
